...
DETECT_WINDOW_DURATION = 0.5
DETECT_MAX_SAMPLES = int(FS * DETECT_WINDOW_DURATION)
TOTAL_CHANNELS = 8
CHANNEL_INDICES = [0, 1, 2, 4]  # (we'll form H = ch1 - ch3, V = ch8 - ch2)
LOWCUT = 0.5
HIGHCUT = 15
FILTER_ORDER = 2
...
DETECT_PERIOD = 0.1  # seconds between detection attempts
